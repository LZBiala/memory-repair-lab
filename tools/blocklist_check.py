...
HASHED_TERMS = frozenset({
    ...
    # This repo additionally bans its own tempting overclaims (the summit's
    # ruling): the banned phrases are hashed like everything else, so CI
    # itself refuses the marketing this project must never use.
    "c4724fc3bc75d378", "0c3d1fd12527efca", "46f19ff96d7de0b2",
    "e23b00bddf36bc94", "efa20274eeb86e59", "c4dcf7f68485245c",
})
